    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-6">
            <div class="small-box bg-info">
                ...
                <a href="?siswa=data_siswa" class="small-box-footer">More Info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-6">
            <div class="small-box bg-success">
                ...
                <a href="?kelas=data_kelas" class="small-box-footer">More Info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
